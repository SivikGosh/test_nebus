"""add field params to models OrganizationActivity and PhoneNumber

Revision ID: 65da4e19ef42
Revises: f2ab1224090b
Create Date: 2025-05-21 11:31:00.418347
...
revision: str = '65da4e19ef42'
down_revision: Union[str, None] = 'f2ab1224090b'
...
def upgrade() -> None:
    ...
    op.alter_column('phone_numbers', '_number',
